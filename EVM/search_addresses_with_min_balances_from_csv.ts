...
const minBalance = 0.0009; // Optional: set a different minimum balance threshold
...
checker.getAddressesWithBalance()
  .then((addressesWithBalance) => {
    console.log('Addresses with balance over the threshold: ' + minBalance, addressesWithBalance);
  })
  .catch((error) => {
